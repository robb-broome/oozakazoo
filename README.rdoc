...
A complete and sweeping cultural transformation, enabled by new technologies, in the understanding that information now owned by the corporations you do business with really ought to be owned by individuals, except that before this, we had no way of keeping track of it, so we assumed it was worthless. 
